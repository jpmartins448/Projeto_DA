...
public:
    ...
    double getWalkingWeight() const { return walkingWeight; }
    void setWalkingWeight(double w) { walkingWeight = w; }
...
template <class T>
Edge<T>::Edge(Vertex<T> *orig, Vertex<T> *dest, double w): orig(orig), dest(dest), drivingWeight(w) {}
